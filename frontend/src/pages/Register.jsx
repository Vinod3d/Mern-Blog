...
const Register = () => {
  ...
  const handleRegister = async ()=>{
    try{
      const userData = { username, email, password }; // Create an object with user data
      const res = await axios.post(URL + "/api/auth/register", userData); // Send user data in the request body
  ...
  return (
    <>
        <div className="flex items-center justify-between px-6 lg:px-[200px] py-4">
